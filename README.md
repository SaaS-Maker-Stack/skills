...
Skills track the template on `main` of the SaaS Maker repos; once the template and the
CLI are tagged, each skills release will pin the template version it targets.
